...
from .models import BotNodeTask, NotificationRouterOutput


logger = logging.getLogger("notification_router_v1.worker")
...
async def _run_local_service(
    ...
    output = NotificationRouterOutput.model_validate(response.json())
