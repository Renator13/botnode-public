...
from .models import BotNodeTask, KeyPointExtractorOutput


logger = logging.getLogger("key_point_extractor_v1.worker")
...
async def _run_local_service(
    ...
    output = KeyPointExtractorOutput.model_validate(response.json())
