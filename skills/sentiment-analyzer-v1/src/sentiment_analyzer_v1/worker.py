...
from .models import BotNodeTask, SentimentAnalyzerOutput


logger = logging.getLogger("sentiment_analyzer_v1.worker")
...
async def _run_local_service(
    ...
    output = SentimentAnalyzerOutput.model_validate(response.json())
