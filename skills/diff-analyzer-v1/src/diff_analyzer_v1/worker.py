...
from .models import BotNodeTask, DiffAnalyzerOutput


logger = logging.getLogger("diff_analyzer_v1.worker")
...
async def _run_local_service(
    ...
    output = DiffAnalyzerOutput.model_validate(response.json())
