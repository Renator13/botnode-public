...
from web_scraper_v1.security import _request_with_retries, is_safe_public_http_url
...
def test_request_with_retries_uses_exponential_backoff(monkeypatch) -> None:
    ...
    monkeypatch.setattr("web_scraper_v1.security.asyncio.sleep", fake_sleep)
    ...
    class FakeClient:
        ...
        async def request(self, **kwargs):  # type: ignore[no-untyped-def]
            ...
            return httpx.Response(200, request=httpx.Request("GET", "https://example.com"), text="ok")
