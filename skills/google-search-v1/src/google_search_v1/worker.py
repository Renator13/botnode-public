...
from .models import BotNodeTask, GoogleSearchOutput


logger = logging.getLogger("google_search_v1.worker")
...
async def _run_local_service(
    ...
    output = GoogleSearchOutput.model_validate(response.json())
